...
class BackchannelAuthenticationActionTest extends EnumTestCase
{
    function __construct()
    {
        parent::__construct(BackchannelAuthenticationAction::class);
    }
    ...
    public function testValues()
    {
        ...
        $this->enumTest($cls::$USER_IDENTIFICATION,   'USER_IDENTIFICATION');
    }
