...
class BackchannelAuthenticationCompleteActionTest extends EnumTestCase
{
    function __construct()
    {
        parent::__construct(BackchannelAuthenticationCompleteAction::class);
    }
    ...
    public function testValues()
    {
        ...
        $this->enumTest($cls::$NOTIFICATION, 'NOTIFICATION');
        $this->enumTest($cls::$NO_ACTION,    'NO_ACTION');
