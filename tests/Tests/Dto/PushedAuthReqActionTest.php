...
class PushedAuthReqActionTest extends EnumTestCase
{
    function __construct()
    {
        parent::__construct(PushedAuthReqAction::class);
    }
    ...
    public function testValues()
    {
        ...
        $this->enumTest($cls::$CREATED,               'CREATED');
        ...
        $this->enumTest($cls::$PAYLOAD_TOO_LARGE,     'PAYLOAD_TOO_LARGE');
