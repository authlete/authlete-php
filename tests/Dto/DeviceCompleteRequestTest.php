...
class DeviceCompleteRequestTest extends TestCase
{
    ...
    public function buildObj(): DeviceCompleteRequest
    {
    ...
    public function testGetters()
    {
        ...
        // result
        $this->assertEquals(DeviceCompleteResult::AUTHORIZED, $obj->getResult());
