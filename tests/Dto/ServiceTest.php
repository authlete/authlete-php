...
class ServiceTest extends TestCase
{
    ...
    private function buildService(): Service
    {
        ...
        $obj->setServiceName('MyService')
            ...
            ->setSupportedRevocationAuthMethods(
                array(
                    ClientAuthMethod::CLIENT_SECRET_POST->value,
                    ClientAuthMethod::CLIENT_SECRET_JWT->value
                )
            )
            ...
            ->setSupportedTokenAuthMethods(
                array(
                    ClientAuthMethod::PRIVATE_KEY_JWT->value,
                    ClientAuthMethod::TLS_CLIENT_AUTH->value
                )
            )
            ...
            ->setSupportedClaimTypes(
                array(
                    ClaimType::NORMAL->value,
                    ClaimType::AGGREGATED->value
                )
            )
            ->setSupportedClaims(
                array(
            ...
            ->setSupportedServiceProfiles(
                array(
                    ServiceProfile::FAPI->value,
                    ServiceProfile::OPEN_BANKING->value
                )
            )
            ...
            ->setSupportedIntrospectionAuthMethods(
                array(
                    ClientAuthMethod::TLS_CLIENT_AUTH->value,
                    ClientAuthMethod::SELF_SIGNED_TLS_CLIENT_AUTH->value
                )
            )
            ...
            ->setSupportedBackchannelTokenDeliveryModes(
                array(
                    DeliveryMode::POLL->value,
                    DeliveryMode::PING->value,
    ...
    public function testGetters()
    {
        ...
        $this->assertTrue(is_array($revocationAuthMethods));
        $this->assertCount(2, $revocationAuthMethods);
        $this->assertEquals(ClientAuthMethod::CLIENT_SECRET_POST->value, $revocationAuthMethods[0]);
        $this->assertEquals(ClientAuthMethod::CLIENT_SECRET_JWT->value,  $revocationAuthMethods[1]);
        ...
        $this->assertTrue(is_array($responseTypes));
        $this->assertCount(2, $responseTypes);
        $this->assertEquals(ResponseType::CODE->value,  $responseTypes[0]);
        $this->assertEquals(ResponseType::TOKEN->value, $responseTypes[1]);
        ...
        $this->assertTrue(is_array($grantTypes));
        $this->assertCount(2, $grantTypes);
        $this->assertEquals(GrantType::AUTHORIZATION_CODE->value, $grantTypes[0]);
        $this->assertEquals(GrantType::IMPLICIT->value,           $grantTypes[1]);
        ...
        $this->assertTrue(is_array($tokenAuthMethods));
        $this->assertCount(2, $tokenAuthMethods);
        $this->assertEquals(ClientAuthMethod::PRIVATE_KEY_JWT->value, $tokenAuthMethods[0]);
        $this->assertEquals(ClientAuthMethod::TLS_CLIENT_AUTH->value, $tokenAuthMethods[1]);
        ...
        $this->assertTrue(is_array($displays));
        $this->assertCount(2, $displays);
        $this->assertEquals(Display::PAGE->value,  $displays[0]);
        $this->assertEquals(Display::POPUP->value, $displays[1]);
        ...
        $this->assertTrue(is_array($claimTypes));
        $this->assertCount(2, $claimTypes);
        $this->assertEquals(ClaimType::NORMAL->value,     $claimTypes[0]);
        $this->assertEquals(ClaimType::AGGREGATED->value, $claimTypes[1]);
        ...
        $this->assertTrue(is_array($snses));
        $this->assertCount(1, $snses);
        $this->assertEquals(Sns::FACEBOOK->value, $snses[0]);
        ...
        $this->assertTrue(is_array($developerSnses));
        $this->assertCount(1, $developerSnses);
        $this->assertEquals(Sns::FACEBOOK->value, $developerSnses[0]);
        ...
        $this->assertTrue(is_array($serviceProfiles));
        $this->assertCount(2, $serviceProfiles);
        $this->assertEquals(ServiceProfile::FAPI->value, $serviceProfiles[0]);
        $this->assertEquals(ServiceProfile::OPEN_BANKING->value, $serviceProfiles[1]);
        ...
        $this->assertTrue(is_array($introspectionAuthMethods));
        $this->assertCount(2, $introspectionAuthMethods);
        $this->assertEquals(ClientAuthMethod::TLS_CLIENT_AUTH->value,             $introspectionAuthMethods[0]);
        $this->assertEquals(ClientAuthMethod::SELF_SIGNED_TLS_CLIENT_AUTH->value, $introspectionAuthMethods[1]);
        ...
        $this->assertTrue(is_array($deliveryModes));
        $this->assertCount(3, $deliveryModes);
        $this->assertEquals(DeliveryMode::POLL->value, $deliveryModes[0]);
        $this->assertEquals(DeliveryMode::PING->value, $deliveryModes[1]);
        $this->assertEquals(DeliveryMode::PUSH->value, $deliveryModes[2]);
